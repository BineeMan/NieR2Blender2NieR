bl_info = {
    "name": "Nier2Blender2NieR Auslander",
    "author": "Woeful_Wolf & Raider AuslanderB",
    "version": (0, 3, 1),
    "blender": (2, 80, 0),
    "description": "Import/Export NieR:Automata WMB/WTP/WTA/DTT/DAT/COL/LAY files. Auslander",
